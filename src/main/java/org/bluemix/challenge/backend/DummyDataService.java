...
public class DummyDataService
{
	...
	public Customer find(String firtsName, String lastName)
	{
		for (Customer contact : contacts.values())
		{
			if (contact.getFirstName().equals(firtsName))
			{
	...
	public synchronized List<Customer> findAll(String stringFilter)
	{
		...
		for (Customer contact : contacts.values())
		{
			...
			{
				Logger.getLogger(DummyDataService.class.getName()).log(Level.SEVERE, null, ex);
			}
		}
	...
	public static DummyDataService createDemoService()
	{
		if (instance == null)
		{
			...
			for (int i = 0; i < 100; i++)
			{
				...
				cal.set(1940 + r.nextInt(60), r.nextInt(11), r.nextInt(28));
				if (r.nextInt(100) % 2 == 0) 
				{
					contact.setGender(Gender.Male);
					if (r.nextInt(100) % 3 == 0)
					{
						contact.setAnnualIncome(0);
					}
					else
					{
						contact.setAnnualIncome(r.nextInt(900)*100+2000);
					}
				}
				else
				{
					...
					{
						contact.setAnnualIncome(r.nextInt(500)*100+2000);
					}
				}
	...
	{ "Peter", "Alice", "John", "Mike", "Olivia", "Nina", "Alex", "Rita", "Dan", "Umberto", "Henrik", "Rene", "Lisa", "Linda", "Timothy", "Daniel", "Brian",
			"George", "Scott", "Jennifer" };
	...
	{ "Smith", "Johnson", "Williams", "Jones", "Brown", "Davis", "Miller", "Wilson", "Moore", "Taylor", "Anderson", "Thomas", "Jackson", "White", "Harris",
			"Martin", "Thompson", "Young", "King", "Robinson" };
